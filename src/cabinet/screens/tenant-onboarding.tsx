...
const NO_BUSINESS_KIND =
  'Чим займається розбірка, сервер не зберігає — у розбірці є назва, місто й логотип.'
const NO_ACCOUNTING_CURRENCY =
  'Основної валюти обліку в API немає: ціни приходять у своїй валюті, а каси рахують кожну окремо й без конвертації.'
const NO_WAREHOUSE_ADDRESS =
  'Адреси складу сервер не зберігає — у складу є назва, код і зони.'
const NO_EMAIL_INVITE =
  'Листів сервер не надсилає й пошти не питає: запрошення — це код, який ви передаєте людині самі.'
            ...
            <div className="grid gap-5">
              <div className="grid gap-4 sm:grid-cols-2">
                <Field hint={NO_EMAIL_INVITE} label="Пошта колеги">
                  <TextInput
                    disabled
                    placeholder="сервер не надсилає листів"
