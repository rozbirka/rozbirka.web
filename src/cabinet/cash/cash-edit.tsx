  ...
  return (
    <div className="type-redesign -mx-4 -mt-6 grid content-start sm:-mx-6 md:-mx-8 md:-mt-8 lg:-mx-10 lg:-mt-10">
      <div className="grid w-full gap-6 px-4 pt-8 pb-16 sm:px-6 md:px-8 md:pt-10 lg:px-12">
        <div>
          <Link
            className="text-app-muted hover:text-app-ink inline-flex items-center gap-1.5 text-[13px] font-medium"
            to={`../${register.id}`}
          >
            <ChevronLeft aria-hidden className="size-3.5" />
            До картки каси
          </Link>
          <h1 className="mt-3 text-[34px] leading-[1.04] font-extrabold tracking-[-0.03em] text-white sm:text-[42px]">
            Редагування каси
          </h1>
          ...
          <div className="grid min-w-0 content-start gap-5">
            ...
            <Step number="04" title="Звіряння й доступ">
              ...
              <Note>
                ...
                лишаються вимкненими, доки такі правила не зʼявляться в
                кабінеті.
              </Note>
            </Step>
          </div>
            ...
            {canManage ? (
              <section className="border-app-line bg-app-raised min-w-0 rounded-[20px] border px-5 py-4.5">
                ...
                <p className="text-app-dim mt-4 text-[12.5px] leading-5 text-pretty">
                  ...
                  касі вже були операції, видалити її не вийде — тоді
                  закривайте.
                </p>
                <Button
